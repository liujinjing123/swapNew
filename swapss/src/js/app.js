           ...
           //  return ERC20Instance._mint(toAddress, amount);
             ...
             var contract_address = address;
               ...
               //  App.contracts.Swap.deployed().then(function(instance){
                      ...
                      SwapInstance = instance;
                      console.log(SwapInstance);
                     return SwapInstance.viewSwap.call();
                      }).then(function(result) {
                        console.log(result);

                        var rateId = result[0].c[0];
                        var short = result[1];
                        var long = result[2];
                        var amount = result[3].c[0];
                        var time = result[4].c[0];
                        var startTime = result[5].c[0];
                        var endTime = result[6].c[0];
                        var floatAmount = result[7].c[0];
                        var fixedAmount = result[8].c[0];
                        var tf = result[9];
                        ...
                        $(".panel-content").append('<strong>startTime</strong>: <span id="startTime">'+ startTime +'</span><br/><br/>');
                        $(".panel-content").append('<strong>endTime</strong>: <span id="endTime">'+ endTime +'</span><br/><br/>');
                        $(".panel-content").append('<strong>floatAmount</strong>: <span id="floatAmount">'+ floatAmount +'</span><br/><br/>');
                        $(".panel-content").append('<strong>fixedAmount</strong>: <span id="fixedAmount">'+ fixedAmount +'</span><br/><br/>');
                        $(".panel-content").append('<strong>是否结束</strong>: <span id="tf">'+ tf +'</span><br/><br/>');
